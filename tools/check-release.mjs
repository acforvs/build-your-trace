...
const ignored = new Set([".git", ".netlify", "dist"]);
const allowedTopLevel = new Set([".github", ".gitignore", "LICENSE", "README.md", "assets", "benchmarks", "data", "index.html", "netlify.toml", "package.json", "schemas", "server.mjs", "src", "styles.css", "tools"]);
